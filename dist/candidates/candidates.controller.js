...
let CandidatesController = class CandidatesController {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.candidatesService.findAll();
        });
    }
    findBy(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.candidatesService.findBy(params.document_number);
        });
    }
};
__decorate([
...
__decorate([
    common_1.Get(":document_number"),
    __param(0, common_1.Param()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CandidatesController.prototype, "findBy", null);
