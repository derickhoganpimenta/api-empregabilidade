...
let CandidatesService = class CandidatesService {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.candidatesRepository.findAll();
        });
    }
    findBy(document_number) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.candidatesRepository.find({ include: [public_tender_entity_1.PublicTender], where: { document_number: document_number } });
        });
    }
};
CandidatesService = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject('CandidatesRepository')),
